...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a class="btn btn-primary" href="{{ route('todo.edit', $todo->id) }}">編集</a></td>　　<!--hrefの謎--　{{}}はechoって意味 rooteメソッド-->
      <td>
        {!! Form::open(['route' => ['todo.destroy', $todo->id], 'method' => 'DELETE']) !!}  <!-- フォームファサード -->
